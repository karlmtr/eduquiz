      ...
      <div class="flex flex-col justify-center gap-3">
        <form class="flex flex-col gap-5">
          <div class="flex">
            ...
            <select v-model="prefs.number_questions">
          ...
          <div class="flex">
            ...
            <select class="w-1/2" v-model="prefs.theme">
        ...
        <button
          ...
          class="flex justify-center gap-2 bg-green-400 px-3 py-4 rounded-lg shadow-md w-2/3 mx-auto my-10 text-center hover:bg-green-500"
          @click="createNewQuiz"
        >
          <svg
            v-show="loading"
